...
import heapq
import random
from single_agent_planner import compute_heuristics, a_star, get_location, get_sum_of_cost, mdd, find_mdd_path, get_mdd_nodes
...
class CBSSolver(object):
    ...
    def find_solution(self, disjoint=True, h=0, p=True):
        ...
        root['h_value'] = h_val(root['mdds'], h, self.my_map)
        #print(root['h_value'])
